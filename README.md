...
```sh
# 1. Bootstrap GraphQL server in directory `lkasjdfasdf`, based on `typescript-advanced` boilerplate
graphql create lkasjdfasdf --boilerplate typescript-advanced
